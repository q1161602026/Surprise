...
class Prediction(namedtuple('Prediction',
    ...
    Args:
        urid: The (raw) user id. See :ref:`this note<raw_inner_note>`.
        irid: The (raw) item id. See :ref:`this note<raw_inner_note>`.
    ...
    def __str__(self):
        s = 'user: {uid:<10} '.format(uid=self.urid)
        s += 'item: {iid:<10} '.format(iid=self.irid)
